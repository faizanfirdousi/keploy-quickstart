...
```bash
curl http://localhost:8082/4KepjkTT
```
or by querying through the browser : http://localhost:8082/4KepjkTT
...
<RecordDiagram />
 ...
 So let's start the application in record mode and make our first request.
